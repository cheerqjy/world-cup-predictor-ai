...
### 2. 防火墙放行
Windows 服务器需要放行 8888 端口：
```powershell
netsh advfirewall firewall add rule name="WorldCup Predictor" dir=in action=allow protocol=TCP localport=8888
```
...
- ✅ **数据准确**：worldcup26.ir API 数据已验证与 FIFA.com 一致
